...
<title>ghumo.com|Hotels & Holidays at best Price!!!</title>
...
#image
{
	background-image: url(./img/backhotel.jpg);
...
<div id="section">
	<div id = "image">
		...
		<div id = "form_hotels">
			<form name = "hotels_form" id = "hotels_form" method = "post" action = "hotels_search_result.php">
				...
				<tr>
					<td colspan = "4">
						<input type = "submit" id = "search_hotels" name = "search_hotels" value = "Search Hotels" style = "margin-left : 25px; height : 40px; width : 150px; background-color : #ff0000; color : white">
					</td>
				</tr>
				</table>
			</form>
	...
	<div id="partner">
		<h1 style = "text-align : center; color : black; text-decoration : underline">Add your business </h1>
		<br><br>
		<h4 style="text-align:center;color:#663300">Have a hotel? Want to start a business?</h4>
		<h3 style = " text-align : center; color : #663300">Register with us now!</h3>
		<input type = "submit" id = "Register_hotel" name = "Register_hotels" value = "Register Now" style = "margin-left : 220px; height : 40px; width : 150px; background-color : #663300; color : white">
	</div>
	<div id="text">
		<h3 style="color:#663300"><marquee>We offer great hotels at low prices. We care about your safety. Keep exploring.</marquee></h3>
	</div>
	<div id = "hotel_details">
		<h1  style = " text-align : center; color : black; text-decoration : underline">Hotel Details</h1>
		<p style = "font-size : 15px; text-align : center; color : #663300">Get the best deals you have ever got... Hurry! it's a limited period offer.</p>
