...
<div id="section">
	<div id = "MyWallet">
		...
		<div id = "My_Wallet_Add_Money">
			<form id = "add_money_wallet" name = "add_money_wallet" method = "post" action = "validate_promo_code.php">
				<h1 style = "text-align : left; margin-left : 25px; color : white; font-size : 14px"><strong>Add Money</strong></h1>
				<input type = "text" name = "Amount_Added" id = "Amount_Added" value = "<?php echo $_SESSION['AMOUNT'];?>" style = "margin-left : 25px; width : 270px; height : 30px; border-radius : 5px; opacity : .8; color : black" placeholder = "Add Amount(Min Rs 1000)" required><br><br>
				<input type = "text" name = "Promo_Code" id = "Promo_Code" style = "margin-left : 25px; width : 200px; height : 30px; border-radius : 5px; opacity : .8; color : black" placeholder = "Have Promo Code">
				<input type = "submit" name = "Apply" id = "Apply" value = "Apply" style = "margin-left : 10px; width : 50px; height : 30px; border-radius : 5px; background-color : #00004d; color : white; margin-top : -30px"><br><br>
				<?php echo '<p style = "font-size : 10px; color : white; margin-left : 10px; margin-top : -18px">'.$_SESSION['APPLICATION_STATUS'].'</p>'?>
				<input type = "submit" name = "Add_Money" id = "Add_Money" value = "Add" style = "margin-left : 25px; width : 110px; color : white; height : 25px; border-radius : 5px; background-color : #000033">
				<p style = "font-size : 12px; color : white; margin-left : 150px; margin-top : -20px"><a style = "color : white; text-decoration : none" href = "">View Wallet Transactions>></a></p>
			</form>
		</div>
	</div>
</div>
