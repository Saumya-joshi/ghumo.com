...
<body>
<div id = "form_flights">
	<form name = "form_oneway" action = "flight_search_result.php" method = "post">
		<table style = "width : 570px">
		<tr>
			<td  colspan = "2" style = "font-size:15px; text-align:left; color:white">
				<input type="radio" id="one" name="oneway" value="oneway.php" onclick = "openLink(this)" target = "frame_1" checked>One-Way&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
				<input type="radio" id="round" name="round" value="roundtrip.php" onclick = "openLink(this)" target = "frame_1">Roundtrip
			</td>
			<td  style = "font-size:15px; text-align:left; color:white">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="radio" id="multi" name="multicity" value="multicity.php" onclick = "openLink(this)" target = "frame_1">Multicity</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type = "date" name = "ReturnDate" style = "height : 25px; width : 225px; border-radius : 5px; background-color : #f2f2f2" disabled></td>
		</tr>
		<tr>
		...
		<td>
			<input type = "submit" name = "search_oneway" style="height : 35px; width : 155px; border-radius: 5px; box-shadow: 5px; background-color : #b30000; color:white; font-size:15px" value="Search Flights">
		</td>
		</tr>
		</table>
	</form>
