...
<div id="section">
	<label id = "label_total_amount">
		<?php
			echo 'Total Amount : '.'<i class="fa fa-inr"></i>&nbsp'.$_SESSION['AMOUNT'];
		?>
	</label>
		...
		<div class="tab-content">
			<div id="select_bank" class="tab-pane fade in active">
				<div id = "form_select_bank">
					...
					<form name = "form_get_bank_name" id = "form_get_bank_name" method = "post" action = "get_bank_name.php">
						<div id = "major_bank">
							<div id = "bank_SBI">
								<input type = "checkbox" class = "bank_checkbox" name = "bank_name" value = "SBI Bank" style = "margin-top : 20px; margin-left : 2px; height : 15px; width : 15px; border-radius : 100px">
								<img src = "./images/SBI_logo.jpg" style = "margin-left : 4px; width : 140; height : 40px; margin-top : 10px; position : absolute">
							</div>
							<div id = "bank_CITI">
								<input type = "checkbox" class = "bank_checkbox" name = "bank_name" value = "CITI Bank" style = "margin-top : 20px; margin-left : 2px; height : 15px; width : 15px; border-radius : 100px">
								<img src = "./images/CITI_logo.jpg" style = "margin-left : 4px; width : 140; height : 40px; margin-top : 10px; position : absolute">
							</div>
							<div id = "bank_PNB">
								<input type = "checkbox" class = "bank_checkbox" name = "bank_name" value = "PNB Bank" style = "margin-top : 20px; margin-left : 2px; height : 15px; width : 15px; border-radius : 100px">
								<img src = "./images/PNB_logo.gif" style = "margin-left : 4px; width : 140; height : 40px; margin-top : 10px; position : absolute">
							</div>
							<div id = "bank_HDFC">
								<input type = "checkbox" class = "bank_checkbox" name = "bank_name" value = "HDFC Bank" style = "margin-top : 20px; margin-left : 2px; height : 15px; width : 15px; border-radius : 100px">
								<img src = "./images/HDFC_logo.jpg" style = "margin-left : 4px; width : 140; height : 40px; margin-top : 10px; position : absolute">
							</div>
							<div id = "bank_AXIS">
								<input type = "checkbox" class = "bank_checkbox" name = "bank_name" value = "AXIS Bank" style = "margin-top : 20px; margin-left : 2px; height : 15px; width : 15px; border-radius : 100px">
								<img src = "./images/AXIS_logo.jpg" style = "margin-left : 4px; width : 140; height : 40px; margin-top : 10px; position : absolute">
							</div>
							<div id = "bank_ICICI">
								<input type = "checkbox" class = "bank_checkbox" name = "bank_name" value = "ICICI Bank" style = "margin-top : 20px; margin-left : 2px; height : 15px; width : 15px; border-radius : 100px">
						...
						<select name = "bank_name" id = "name_of_bank" style = "width : 260px; height : 40px; margin-left : 25px; margin-top : 225px; background-color :#f2f2f2; border-radius : 4px; color : black">
							...
							<option value = "Bank of Behrain and Kuwait">Bank of Behrain and Kuwait</option>
							<option value = "Bank of Baroda">Bank Of Baroda</option>
							<option value = "Bank of India">Bank of India</option>
							<option value = "Bank Of Maharashtra">Bank of Maharashtra</option>
							<option value = "Canara Bank">Canara Bank</option>
							<option value = "Vijya Bank">Vijya Bank</option>
						...
						<?php
							echo '<p style = "font-size : 10px; color : red; margin-left : 15px; margin-top : 5px; position : absolute">'.$_SESSION['SELECT_BANK_NAME_ERROR_MESSAGE'];
						?>
					</form>
				</div>
			</div>
			<div id="secure_login" class="tab-pane fade">
				<div id = "login_bank">
					<label class = "lbl_bank_name">
						<?php
							echo 'Login To '.$_SESSION['NET_BANKING_BANK_NAME'];
						?>
					</label>
					<form name = "login_to_bank" id = "login_to_bank" method = "post" action = "login_net_banking.php">
						<table style = "width : 380px; margin-top : 60px; position : absolute; margin-left : 25px">
							<tr>
								...
								<td><input type = "text" name = "customer_id" style = "height : 30px; width : 240px; background-color : #f2f2f2; border-radius : 4px" placeholder = "Customer Id"></td>
							</tr>
							<tr>
								<td style = "font-size : 13px; text-align : left; color : black; font-weight : 600; width : 120px">Login Password : </td>
								<td><input type = "password" name = "login_password" style = "height : 30px; width : 240px; background-color : #f2f2f2; border-radius : 4px" placeholder = "Login Password"></td>
							</tr>
							<tr>
								<td colspan = "2"><input type = "submit" name = "login_bank_net" id = "login_bank_net" value = "Login" style = "margin-left : 25px; height : 32px; width : 150px; color : white; background-color :#00004d; border-radius : 5px; position : absolute; margin-top : 10px"><p style = "font-size : 15px; color : blue; margin-left : 245px; margin-top : 10px"><a style = "text-decoration : none; cursor : pointer" href = "">Cancel</a></p>
								</td>
							</tr>
						</table>
						<?php
								echo '<p style = "font-size : 12px; color : red; margin-left : 15px; margin-top : 43px; position : absolute">'.$_SESSION['ENTER_VALID_USER_ID_OR_PASSWORD_ERROR_MESSAGE'];
						?>
					</form>
				</div>
			</div>
			<div id="make_transactions" class="tab-pane fade">
				<div id = "login_bank_transaction">
					...
					<form name = "transact_to_bank" id = "transact_to_bank" method = "post" action = "make_transaction.php">
						<table style = "width : 380px; margin-top : 60px; position : absolute; margin-left : 25px">
							<tr>
								<td style = "font-size : 13px; text-align : left; color : black; font-weight : 600; width : 120px">Customer Id : </td>
						...
						<?php
							echo '<p style = "font-size : 12px; color : red; margin-left : 15px; margin-top : 43px; position : absolute">'.$_SESSION['OTP_NET_BANKING_SENT_MESSAGE'];
						?>
					</form>
				</div>
			</div>
...
$(document).ready(function(){
	...
	if(window.location.hash == '#debit_card_validate_otp')
	{
		...
		$('.me_nu li:eq(0)').removeClass('active');
		$('.me_nu li:eq(1)').addClass('active');
		$('#debit-card').show();
	...
	if(window.location.hash == '#select_bank')
	{
		$('.me_nu li:eq(0)').removeClass('active');
		$('.me_nu li:eq(2)').addClass('active');
		$('#net-banking').show();
		$('#net_banking_tabs li:eq(0) a').tab('show');
	}
	
	if(window.location.hash == '#secure_login')
	{
		$('.me_nu li:eq(0)').removeClass('active');
		$('.me_nu li:eq(2)').addClass('active');
		$('#net-banking').show();
	...
	if(window.location.hash == '#make_transactions')
	{
		$('.me_nu li:eq(0)').removeClass('active');
		$('.me_nu li:eq(2)').addClass('active');
		$('#net-banking').show();
	...
	if(window.location.hash == '#confirmation_message')
	{
		$('.me_nu li:eq(0)').removeClass('active');
		$('.me_nu li:eq(2)').addClass('active');
		$('#net-banking').show();
...
<script>
$(document).ready(function() {
	$('.bank_checkbox').on('change', function() {
		$('.bank_checkbox').not(this).prop('checked', false);  
	});
});
</script>
...
<script>
$(document).ready(function() {
	$('input[type="checkbox"].bank_checkbox').click(function(){
    if ($(this).is(':checked'))
        $("#name_of_bank").prop('disabled', 'disabled');
	else
	{
		$("#name_of_bank").prop('disabled', false);
		//$('.bank_checkbox').prop('disabled', 'disabled');
	}
	});
});
</script>
...
<script>
$(document).ready(function(){
	$('select #name_of_bank').click(function()
	{
		$('.bank_checkbox').prop('disabled', 'disabled');
	}
});
...
$(document).ready(function() {
	$('.bank_checkbox').click(function()
	{
		...
		{
			var BN = $(this).val();
			$('#name_of_bank').append('<option value =  "SBI" selected = "selected"></option>');
		}
		else
		{
			$('select #name_of_bank option[value = "BN"]').remove();
		}
	});
	/*{
		var value = (this).val();
		$('#name_of_bank').val(value);
	}*/
	/*$('.bank_checkbox').on('change', function() {
		$('.bank_checkbox').not(this).prop('checked', false);  
	});*/
